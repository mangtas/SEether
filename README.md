...
### Instruction
Copy and Paste this script <pre lang="no-highlight">```wget https://raw.githubusercontent.com/mangtas/SEether/master/seautoscriptupdated && chmod +x seautoscriptupdated && ./seautoscriptupdated```</pre>into your terminal
